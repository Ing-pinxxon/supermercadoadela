    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-2">
        ...
        <div className="flex shrink-0 gap-2 text-sm">
          <Link
            href={`/caja?semana=${sumarDias(lunes, -7)}`}
      ...
      <Tarjeta titulo="Total de la semana">
        ...
        <div className="mt-3 border-t border-dashed border-gray-200 pt-2">
          <Fila etiqueta="Venta en efectivo" valor={r.totales.ventaEfectivo} />
          <Fila etiqueta="Salidas" valor={r.totales.salidas} />
          <Fila etiqueta="Entradas" valor={-r.totales.entradas} />
        </div>
      </Tarjeta>
